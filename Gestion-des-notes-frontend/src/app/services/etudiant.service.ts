...
export class EtudiantService {
  ...
  listeEtudiant(promo:any,annee:any): Observable<Etudiant[]>{
    ...
    listeEtudiantType(promo:any,annee:any,type:any): Observable<Etudiant[]>{
      return this.http.get<Etudiant[]>(`${this.apiURL+'/listeMobilite/'}?promo=${promo}&annee=${annee}&type=${type}`); }
   ...
   */
    ...
    {  return this.http.post( 'http://localhost:8080/api/excel/note',file); }
      ...
      public editeEtudiant(etudiant: Etudiant,id: number): Observable<Etudiant> 
      { return this.http.post<Etudiant>(`${this.apiURL +'/addMobilite' }/${id}` , etudiant); }
