...
export class NoteService {
  ...
  listeEtudiant(promo:any,annee:any): Observable<any[]>{
    ...
    listeNotesMatiere(codeUnite:any,numero:any, annee:any): Observable<any[]>{
      return this.http.get<any>(`${this.apiURL+'/notes/unite/etudiant'}?code=${codeUnite}&numero=${numero}&annee=${annee}`);
    }
